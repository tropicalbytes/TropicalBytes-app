      ...
      <section className="mx-auto max-w-content px-5 py-14 md:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <LegalSection number={3} title="Pricing">
            <p>
              Our Menu and Meal Plans pages display our current weekly meal-plan rates, add-on prices, and
              party/bulk per-kg pricing, along with an estimated total shown while you fill out the
              subscription form. These figures reflect our listed rates, but the final confirmed total for
              your specific request may depend on your selected meals, quantity, plan duration, delivery
              location, availability, and any specific requirements you share with us. We&apos;ll confirm
              final pricing with you directly before your order is finalized.
            </p>
          </LegalSection>

          <LegalSection number={4} title="Availability">
            <p>
              Meals, plans, salads, add-ons, and party/bulk items are subject to availability. Your
